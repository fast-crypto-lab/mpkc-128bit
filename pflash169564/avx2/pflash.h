...
void pflash_secmap_fft( uint8_t * w , const pflash_key * sk , const uint8_t * z , const uint8_t seed[_LEN_SHA256_])
{
	...
	uint8_t _z[_PUB_N_BYTE] __attribute__((aligned(32))),y[_PUB_N_BYTE] __attribute__((aligned(32)));
	uint8_t x[_PUB_N_BYTE] __attribute__((aligned(32))),_w[_PUB_N_BYTE] __attribute__((aligned(32)));
