...
static inline unsigned gf65536_mul( unsigned a , unsigned b )
{
	unsigned char a0 = a&0xff;
	unsigned char a1 = (a>>8);
	unsigned char b0 = b&0xff;
	unsigned char b1 = (b>>8);
	unsigned char a0b0 = gf256_mul( a0 , b0 );
	unsigned char a1b1 = gf256_mul( a1 , b1 );
	unsigned char a0b1_a1b0_a1b1 = gf256_mul( a0^a1 , b0^b1)^a0b0;
	unsigned char a1b1x80 = gf256_mul_0x80( a1b1 );

	return ((unsigned)a0b0^a1b1x80)^(((unsigned)a0b1_a1b0_a1b1)<<8);

}


static inline unsigned gf65536_mul_gf256( unsigned a , unsigned char b )
{
	unsigned char a0 = a&0xff;
	unsigned char a1 = (a>>8);
	unsigned char a0b = gf256_mul( a0 , b );
	unsigned char a1b = gf256_mul( a1 , b );
	return ((unsigned)a0b)^(((unsigned)a1b)<<8);
}


static inline unsigned gf65536_squ( unsigned a )
{
	unsigned char a0 = gf256_squ( a&0xff );
	unsigned char a1 = gf256_squ( a>>8 );
	unsigned char a1squ_x8 = gf256_mul_0x80( a1 );
	return ((unsigned)a0^a1squ_x8)^(((unsigned)a1)<<8);
}

static inline unsigned gf65536_mul_0x8000( unsigned a )
{
	unsigned a0 = a&0xffff;
	unsigned a1 = (a>>16)&0xffff;
	unsigned a0x80 = gf256_mul_0x80( a0 );
	unsigned a1x80 = gf256_mul_0x80( a1 );
	unsigned a1x80x80 = gf256_mul_0x80( a1x80 );
	return ((a0x80^a1x80)<<16)^a1x80x80;
}

static inline unsigned gf65536_inv( unsigned a )
{
// 128+64+32+16+8+4+2 = 254
	unsigned a2 = gf65536_squ(a);
	unsigned a4 = gf65536_squ(a2);
	unsigned a8 = gf65536_squ(a4);

	unsigned a4_2 = gf65536_mul( a4 , a2 );
	unsigned a8_4_2 = gf65536_mul( a4_2 , a8 );
	unsigned a64_ = gf65536_squ( a8_4_2 );
	a64_ = gf65536_squ( a64_ );
	a64_ = gf65536_squ( a64_ );
	unsigned a64_2 = gf65536_mul( a64_ , a8_4_2 );
	unsigned a128_ = gf65536_squ( a64_2 );
	unsigned a_fe =  gf65536_mul( a2 , a128_ );
	unsigned a_ff = gf65536_mul( a_fe , a );
	unsigned a_ff00 = gf65536_squ( a_ff );
	a_ff00 = gf65536_squ( a_ff00 );
	a_ff00 = gf65536_squ( a_ff00 );
	a_ff00 = gf65536_squ( a_ff00 );
	a_ff00 = gf65536_squ( a_ff00 );
	a_ff00 = gf65536_squ( a_ff00 );
	a_ff00 = gf65536_squ( a_ff00 );
	a_ff00 = gf65536_squ( a_ff00 );
	return gf65536_mul( a_ff00 , a_fe );
}



// gf832 := gf65536[X]/X^2+X+0x8000
static inline unsigned gf832_mul( unsigned a , unsigned b )
{
	unsigned a0 = a&0xffff;
	unsigned a1 = (a>>16);
	unsigned b0 = b&0xffff;
	unsigned b1 = (b>>16);
	unsigned ab0 = gf65536_mul( a0 , b0 );
	unsigned ab2 = gf65536_mul( a1 , b1 );
	unsigned ab1 = gf65536_mul( a0^a1 , b0^b1)^ab0;
	unsigned ab2x8000 = gf65536_mul_0x8000( ab2 );

	return (ab1<<16)^(ab0^ab2x8000);
}

static inline unsigned gf832_squ( unsigned a )
{
	unsigned a0 = a&0xffff;
	unsigned a1 = (a>>16);
	unsigned ab0 = gf65536_squ( a0 );
	unsigned ab2 = gf65536_squ( a1 );
	unsigned ab2x8000 = gf65536_mul_0x8000( ab2 );

	return (ab2<<16)^(ab0^ab2x8000);
}
...
static inline uint32_t gf256_3_mul( uint32_t a , uint32_t b )
{
	uint8_t a0 = a&0xff;
	uint8_t a1 = (a>>8)&0xff;
	...
	uint8_t a0b0 = gf256_mul( a0 , b0 );
	uint8_t a1b1 = gf256_mul( a1 , b1 );
	uint8_t a2b2 = gf256_mul( a2 , b2 );
	uint8_t a0a1_b0b1 = gf256_mul( a0^a1 , b0^b1 );
	uint8_t a1a2_b1b2 = gf256_mul( a1^a2 , b1^b2 );
	uint8_t a0a1a2_b0b1b2 = gf256_mul( a0^a1^a2 , b0^b1^b2 );

	uint8_t r3 = a1b1^a2b2^a1a2_b1b2;
	//uint8_t r4 = a2b2;

	uint32_t r = a0b0^gf256_mul_0x2(r3);
	r ^= ( (uint32_t)(a0b0^a1b1^a0a1_b0b1 ^ gf256_mul_0x2(a2b2)) )<<8;
	r ^= ((uint32_t)(a0a1_b0b1^a1a2_b1b2^a0a1a2_b0b1b2))<<16;
	return r;
}

static inline uint32_t gf256_3_mul_0x2( uint32_t a )
{
	uint8_t a0 = a&0xff;
	uint8_t a1 = (a>>8)&0xff;
	uint8_t a2 = (a>>16)&0xff;
	uint8_t r0 = gf256_mul_0x2(a0);
	uint8_t r1 = gf256_mul_0x2(a1);
	uint8_t r2 = gf256_mul_0x2(a2);
	return ((uint32_t)r0)|(((uint32_t)r1)<<8)|(((uint32_t)r2)<<16);
}

static inline uint32_t gf256_3_mul_0x10( uint32_t a )
{
	uint8_t a0 = a&0xff;
	uint8_t a1 = (a>>8)&0xff;
	uint8_t a2 = (a>>16)&0xff;
	uint8_t r0 = gf256_mul_0x10(a0);
	uint8_t r1 = gf256_mul_0x10(a1);
	uint8_t r2 = gf256_mul_0x10(a2);
	return ((uint32_t)r0)|(((uint32_t)r1)<<8)|(((uint32_t)r2)<<16);
}

// gf256^3 := gf256[X]/X^3+0x2
// X^4 = 0x2 X
static inline uint32_t gf256_3_squ( uint32_t a )
{
	uint8_t a0 = a&0xff;
	uint8_t a1 = (a>>8)&0xff;
	uint8_t a2 = (a>>16)&0xff;
	uint8_t r0 = gf256_squ(a0);
	uint8_t r2 = gf256_squ(a1);
	uint8_t r4 = gf256_squ(a2);
	uint8_t r1 = gf256_mul_0x2(r4);
	return ((uint32_t)r0)|(((uint32_t)r1)<<8)|(((uint32_t)r2)<<16);
}


static inline void bs_gf256_add( sto_t * r , const sto_t * a , const sto_t * b )
{
	r[0] = a[0]^b[0];
	r[1] = a[1]^b[1];
	r[2] = a[2]^b[2];
...
static inline void bs_gf256_3_mul( sto_t * r , const sto_t * a , const sto_t * b )
{
	sto_t a0b0[8]; bs_gf256_mul( a0b0 , a , b );
	sto_t a1b1[8]; bs_gf256_mul( a1b1 , a+8 , b+8 );
	sto_t a2b2[8]; bs_gf256_mul( a2b2 , a+16 , b+16 );

	sto_t tmp1[8]; bs_gf256_add( tmp1 , a , a+8 );
	sto_t tmp2[8]; bs_gf256_add( tmp2 , b , b+8 );
	sto_t a0a1_b0b1[8]; bs_gf256_mul( a0a1_b0b1 , tmp1 , tmp2 );

	bs_gf256_add( tmp1 , tmp1 , a+16 );
	bs_gf256_add( tmp2 , tmp2 , b+16 );
	sto_t a0a1a2_b0b1b2[8]; bs_gf256_mul( a0a1a2_b0b1b2 , tmp1 , tmp2 );

	bs_gf256_add( tmp1 , a+8 , a+16 );
	bs_gf256_add( tmp2 , b+8 , b+16 );
	sto_t a1a2_b1b2[8]; bs_gf256_mul( a1a2_b1b2 , tmp1 , tmp2 );

	sto_t r3[8];
	bs_gf256_add( tmp1 , a1b1 , a2b2 );
	bs_gf256_add( tmp2 , tmp1 , a1a2_b1b2 );
	bs_gf256_mul_0x2( r3 , tmp2 );

	sto_t r4[8]; bs_gf256_mul_0x2( r4 , a2b2 );

	bs_gf256_add( r , a0b0 , r3 );

	bs_gf256_add( tmp1 , a0b0 , a1b1 );
	bs_gf256_add( tmp2 , a0a1_b0b1 , r4 );
	bs_gf256_add( r+8 , tmp1 , tmp2 );

	bs_gf256_add( tmp1 , a0a1_b0b1 , a1a2_b1b2 );
	bs_gf256_add( r+16 , tmp1 , a0a1a2_b0b1b2 );
}


static inline void bs_gf256_3_set_value( sto_t * regs , uint32_t val )
{
	uint8_t v0 = val&0xff;
	uint8_t v1 = (val>>8)&0xff;
	uint8_t v2 = (val>>16)&0xff;
	bs_gf256_set_value( regs , v0 );
	bs_gf256_set_value( regs+8 , v1 );
	bs_gf256_set_value( regs+16 , v2 );
}

static inline uint32_t bs_gf256_3_get_1st_value( const sto_t * regs )
{
	uint32_t r0 = bs_gf256_get_1st_value( regs );
	uint32_t r1 = bs_gf256_get_1st_value( regs+8 );
	uint32_t r2 = bs_gf256_get_1st_value( regs+16 );
